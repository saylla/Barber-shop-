...
export const INITIAL_PROFESSIONALS: Professional[] = [
  {
    ...
    daysOff: [],
    phone: '(11) 97111-2233',
    email: 'carlos.barber@barberflow.com.br',
    address: 'Rua Oscar Freire, 1420',
    city: 'São Paulo - SP',
    zipCode: '01426-001',
    pixKey: 'carlos.barber@barberflow.com.br',
    pixKeyType: 'email',
  },
  {
    id: 'prof-2',
    ...
    daysOff: [],
    phone: '(11) 97222-3344',
    email: 'mateus.barber@barberflow.com.br',
    address: 'Rua Oscar Freire, 1420',
    city: 'São Paulo - SP',
    zipCode: '01426-001',
    pixKey: '11972223344',
  ...
  },
  {
    ...
    daysOff: [],
    phone: '(11) 97333-4455',
    email: 'rafael.barber@barberflow.com.br',
    address: 'Rua Augusta, 2100',
    city: 'São Paulo - SP',
    zipCode: '01412-100',
    pixKey: 'rafael.barber@barberflow.com.br',
    pixKeyType: 'email',
  },
];

export const INITIAL_PACKAGES: MonthlyPackage[] = [
  {
    id: 'pkg-1',
    name: 'Clube VIP Cabelo Livre',
    tagline: 'Corte ilimitado com estilo impecável o mês todo',
    description: 'Para quem gosta de manter o degradê e o alinhamento sempre em dia. Venha quantas vezes quiser no mês com atendimento prioritário.',
    price: 119.90,
    benefits: [
      'Cortes de cabelo ilimitados no mês',
      'Acabamentos e pezinho semanais inclusos',
      '10% de desconto em pomadas e cosméticos',
      'Café Nespresso e Cerveja Heineken cortesia',
    ],
    servicesIncludedText: 'Cortes ilimitados + Pezinho',
    cutsPerMonth: 'unlimited',
    beardsPerMonth: 0,
    image: 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?auto=format&fit=crop&w=600&q=80',
    active: true,
    popular: true,
  ...
  {
    id: 'pkg-2',
    name: 'Combo Mensal Cabelo & Barba',
    tagline: 'O pacote completo mais vendido para o homem moderno',
    description: 'Assinatura mensal com 4 atendimentos completos no mês. Ideal para manter cabelo e barba alinhados com toalha quente e massagem.',
    price: 169.90,
    benefits: [
      '4 Cortes Masculinos Completos por mês',
      '4 Barboterapias com Toalha Quente e Navalha',
      'Sobrancelha alinhada na pinça ou navalha',
      '15% de desconto em qualquer produto da barbearia',
    ],
    servicesIncludedText: '4 Cortes + 4 Barbas por mês',
    cutsPerMonth: 4,
    beardsPerMonth: 4,
    image: 'https://images.unsplash.com/photo-1622286342621-4bd786c2447c?auto=format&fit=crop&w=600&q=80',
    active: true,
  ...
  {
    id: 'pkg-3',
    name: 'Plano Barba de Respeito',
    tagline: 'Cuidado semanal com hidratação e toalha quente',
    description: 'Focado nos barbudos exigentes. Alinhamento de contornos, hidratação com óleos essenciais e acabamento com navalha toda semana.',
    price: 89.90,
    benefits: [
      'Até 4 Barboterapias completas por mês',
      'Aplicação de Balm e Óleo Amadeirado',
      'Toalha quente com óleos essenciais',
      'Pezinho do pescoço sempre limpo',
    ],
    servicesIncludedText: '4 Barboterapias completas',
    cutsPerMonth: 0,
    beardsPerMonth: 4,
    image: 'https://images.unsplash.com/photo-1585747860715-2ba37e788b70?auto=format&fit=crop&w=600&q=80',
    active: true,
  ...
  {
    id: 'pkg-4',
    name: 'Assinatura Executiva Prime',
    tagline: 'Acesso VIP irrestrito a todos os serviços da casa',
    description: 'A experiência definitiva de cuidados masculinos. Cortes e barbas sem limites, lavagem especial com massagem capilar e produtos exclusivos.',
    price: 219.90,
    benefits: [
      'Cortes e Barboterapias ILIMITADOS no mês',
      'Tratamento antiqueda e hidratação capilar mensal',
      '1 Pomada Modeladora de cortesia na primeira adesão',
      'Agendamento VIP com prioridade de encaixe',
    ],
    servicesIncludedText: 'Cabelo e Barba Ilimitados + Tratamentos VIP',
    cutsPerMonth: 'unlimited',
    beardsPerMonth: 'unlimited',
    image: 'https://images.unsplash.com/photo-1512690459411-b9245aed614b?auto=format&fit=crop&w=600&q=80',
    active: true,
    popular: false,
    barberId: 'all',
...
export const INITIAL_PRODUCTS: BarberProduct[] = [
  {
    id: 'prod-1',
    name: 'Pomada Matte Clay Extra Forte 120g',
    brand: 'BarberFlow Pro Grooming',
    category: 'pomadas',
    description: 'Fixação extra forte com acabamento 100% fosco e natural. Resistente ao suor e umidade, fácil de lavar à base d’água.',
    price: 48.00,
    promotionalPrice: 42.00,
    stock: 24,
    image: 'https://images.unsplash.com/photo-1597854710119-a5a843967365?auto=format&fit=crop&w=600&q=80',
    active: true,
    featured: true,
    barberId: 'all',
  },
  {
    id: 'prod-2',
    name: 'Óleo Hidratante Barba Amadeirado 30ml',
    brand: 'BarberFlow Gold Care',
    category: 'barba',
    description: 'Fórmula nobre com óleo de argan, jojoba e semente de uva. Hidratação profunda, perfume marcante amadeirado e brilho saudável sem engordurar.',
    price: 45.00,
    promotionalPrice: 39.90,
    stock: 18,
    image: 'https://images.unsplash.com/photo-1626015365107-275d3156cf38?auto=format&fit=crop&w=600&q=80',
    active: true,
    featured: true,
    barberId: 'prof-2',
    barberName: 'Mateus Silva',
  ...
  {
    id: 'prod-3',
    name: 'Gel Cola Black Fixador Extra Forte 250g',
    brand: 'BarberFlow Tech Line',
    category: 'finalizador',
    description: 'Gel cola de ultra fixação com micropigmentação preta sutil para disfarçar fios brancos ou falhas no degradê. Não resseca.',
    price: 32.00,
    stock: 35,
  ...
  {
    id: 'prod-4',
    name: 'Balm Modelador & Pós-Barba Refrescante 100g',
    brand: 'BarberFlow Grooming',
    category: 'barba',
    description: 'Acalma a pele pós-lâmina, elimina a coceira do crescimento e alinha os fios rebeldes com mentol e extrato de camomila.',
    price: 38.00,
    stock: 20,
    image: 'https://images.unsplash.com/photo-1608248597359-009761e389e6?auto=format&fit=crop&w=600&q=80',
    active: true,
    featured: true,
    barberId: 'all',
  },
  {
    id: 'prod-5',
    name: 'Shampoo Fortificante Antiqueda & Mentol 250ml',
    brand: 'BarberFlow Hair Care',
    category: 'shampoo',
    description: 'Estimula a microcirculação do couro cabeludo com cafeína, biotina e mentol refrescante. Controla a oleosidade e previne a queda.',
    price: 49.90,
  ...
  {
    id: 'prod-6',
    name: 'Pente Artesanal de Madeira Anti-Estática',
    brand: 'BarberFlow Craft',
    category: 'acessorios',
    description: 'Feito em madeira nobre de lei. Evita o efeito frizz, desembaraça suavemente e espalha os óleos naturais por toda a extensão dos fios.',
    price: 28.00,
    stock: 40,
    image: 'https://images.unsplash.com/photo-1590159763121-7c9ff3149e0a?auto=format&fit=crop&w=600&q=80',
    active: true,
    featured: false,
    barberId: 'all',
  },
...
export const INITIAL_SETTINGS: ShopSettings = {
  ...
  pixKey: 'contato@barberflow.com.br',
  pixKeyType: 'email',
  pixReceiverName: 'BarberFlow Studio Oficial',
  pixCity: 'SAO PAULO',
};
...
export const ADMIN_USER: UserAccount = {
  id: 'usr-admin-1',
  name: 'Matheus Briza (Proprietário & TI)',
...
export const INITIAL_SYSTEM_USERS: UserAccount[] = [
  ...
  },
  {
    ...
    lastLogin: '2026-08-27T08:15:00Z',
  },
  {
    id: 'usr-barber-3',
    name: 'Rafael Santos',
    ...
    provider: 'direct',
    active: true,
    mustChangePassword: true, // Demonstrating mandatory password change on first login!
    password: '1234',
